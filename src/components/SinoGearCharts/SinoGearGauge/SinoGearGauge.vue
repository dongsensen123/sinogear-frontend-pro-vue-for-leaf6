<template>
  <div>
    <v-chart :forceFit="true" :height="height" :data="data" :scale="scale" :padding="[-16, 0, 16, 0]">
      <v-coord type="polar" :startAngle="-222.5" :endAngle="42.5" :radius="0.85"></v-coord>
      <v-axis
        dataKey="value"
        :zIndex="2"
        :line="null"
    ...
    data() {
      return {
        ...
        <div style="width: 300px;text-align: center;">
          <p style="font-size: 14px;color: rgba(0, 0, 0, 0.43);margin: 0;">跳出率</p>
          <p style="font-size: 24px;color: rgba(0, 0, 0, 0.85);margin: 0;">${data[0].value * 10}%</p>
        </div>
      `,
      };
    },
